...
const reduxMiddlewares = [routerMiddleware(createMemoryHistory()), sagaMiddleware]

export const configureStore = (initialState = {}) => {
    const store: any = createStore(rootReducer, initialState, compose(applyMiddleware(...reduxMiddlewares)))
